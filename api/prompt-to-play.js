...
// tolerant, inline scanner (no local imports)
...
export default async function handler(req, res) {
  try {
    ...
    // insert with both slug + share_slug; fallbacks if schema differs
    ...
    const urlPath = `/play?slug=${finalSlug}`;               // <-- standardize to /play
